(function(exports, global) {
    ...
    var application = angular.module("facebookUtils", [ "firebase" ]).constant("facebookConfigDefaults", defaultSettings).value("facebookConfigSettings", defaultSettings).run([ "facebookConfigSettings", "facebookConfigDefaults", "$rootScope", "$location", "facebookSDK", "angularFireCollection", "$route", function(facebookConfigSettings, facebookConfigDefaults, $rootScope, $location, facebookSDK, angularFireCollection, $route) {
    ...
    "use strict";
    angular.module("facebookUtils").directive("facebookLogin", [ "$rootScope", "angularFire", "facebookSDK", "facebookConfigSettings", function($rootScope, angularFire, facebookSDK, facebookConfigSettings) {
        return {
