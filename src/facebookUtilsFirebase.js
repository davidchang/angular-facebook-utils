(function(exports, global) {
    global["true"] = exports;
    "use strict";
    var application = angular.module("facebookUtils", [ "firebase" ]).value("facebookConfigSettings", {
        firebaseURL: "",
        appID: "",
        permissions: "",
        ...
        loginPath: "/"
    }).run([ "facebookConfigSettings", "$rootScope", "$location", "facebookSDK", "angularFireCollection", function(facebookConfigSettings, $rootScope, $location, facebookSDK, angularFireCollection) {
    ...
    "use strict";
    angular.module("facebookUtils").directive("facebookLogin", [ "angularFire", "facebookSDK", "facebookConfigSettings", function(angularFire, facebookSDK, facebookConfigSettings) {
        return {
